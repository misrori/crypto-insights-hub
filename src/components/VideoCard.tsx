      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start justify-between gap-4 mb-4">
          ...
          <a
            ...
            className="flex items-center justify-center h-10 w-10 rounded-lg bg-secondary hover:bg-primary hover:text-primary-foreground transition-all duration-200 shrink-0"
